  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        value={value}
        spellCheck={false}
        className={`w-full min-h-[8rem] resize-y rounded-md border border-white/10 bg-black/30 p-3 text-sm text-white/90 outline-none focus:border-sky-500/60 ${className}`}
        {...props}
      />
    </div>
  );
